 ...
 */
class jh9RobokassaExtension extends Extension
{
    /**
     * {@inheritDoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('jh9.robokassa.login', $config['login']);
        ...
        $container->setParameter('jh9.robokassa.url', $config['url']);
